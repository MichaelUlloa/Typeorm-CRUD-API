...
var getUserById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var paramId, userFound;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                paramId = req.params.id;
                return [4 /*yield*/, typeorm_1.getRepository(User_1.User).findOne(paramId)];
            case 1:
                userFound = _a.sent();
                return [2 /*return*/, res.json(userFound)];
        }
    });
}); };
exports.getUserById = getUserById;
var updateUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var paramId, user, results;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                paramId = req.params.id;
...
var deleteUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                paramId = req.params.id;
                return [4 /*yield*/, typeorm_1.getRepository(User_1.User).delete(paramId)];
            case 1:
                results = _a.sent();
                return [2 /*return*/, res.json(results)];
        }
